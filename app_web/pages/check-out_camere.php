...
if (isset($_POST["check-submit"])) {
									...
									$sql = "UPDATE camera SET Stato='0' WHERE Numero='$n'";
    ...
    //Camere Libere
    $sql = "SELECT * FROM camera WHERE Stato='1'";
    $result = mysqli_query($conn, $sql);
...
?>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header">Check-Out Camere</h3>		
                        </div>
                        <!-- /.col-lg-12 -->
                                ...
                                <div class="table-responsive">
								    ...
								    if ($n_camere==0){
                                              echo'<div class="alert alert-info">
				                                 ...
				                                 echo"<thead>
                                                        <tr> <th>N° Camera</th> <th>Piano</th> <th>Posti Letto</th> <th>Tipo</th> <th>Esegui Check-Out</th> </tr>
                                                      </thead>
                                                      <tbody>";
									...
									?> 
																				...
																				echo"  <input type='hidden' name='camera' value='$numero'> 
																					   <button type='submit' class='btn btn-danger' name='check-submit'>Check-Out</button> 
																			    </form>
																				</td> </tr>";
					                                }//fine while
