...
/**
 * Questa classe definisce un oggetto FrameRisultatiRicercaUtente
 * @author Daniele
 *
 */
public class FrameRisultatiRicercaUtente extends JFrame{
	 ...
	 */
		public FrameRisultatiRicercaUtente(Contenitore c,ArrayList<Account> a){
			...
			BarraMenuIS barra=new BarraMenuIS(frame,contenitore,11);
