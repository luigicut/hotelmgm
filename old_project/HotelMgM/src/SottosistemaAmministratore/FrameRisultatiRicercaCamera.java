...
/**
 * Questa classe definisce un oggetto FrameRisultatiRicercaCamera
 * @author Daniele
 *
 */
public class FrameRisultatiRicercaCamera extends JFrame{
	 ...
	 */
		public FrameRisultatiRicercaCamera(Contenitore c, ArrayList<Camera> arr){
			...
			BarraMenuIS barra=new BarraMenuIS(frame,contenitore,10);
