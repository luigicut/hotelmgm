...
/**
 * Questa classe definisce un oggetto FrameRisultatiRicercaCliente
 * @author Daniele
 *
 */
public class FrameRisultatiRicercaCliente extends JFrame{
	 ...
	 */
		public FrameRisultatiRicercaCliente(Contenitore c,ArrayList<Cliente> arr){
	...
	class addActionListenerAvanti implements ActionListener
	{
		public void actionPerformed(ActionEvent event){
			...
			try {
			          ...
			          arrayCli2=d.getDettagliCliente(codiceCliente);
					    }	         
	...
	JLabel ins=new JLabel("Inserire il codice del cliente per visualizzare i dettagli: ");
