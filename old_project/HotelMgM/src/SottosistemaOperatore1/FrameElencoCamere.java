...
/**
 * Questa classe definisce un oggetto FrameElencoCamere
 * @author Daniele
 *
 */
public class FrameElencoCamere extends JFrame{
	 ...
	 */
		public FrameElencoCamere(Contenitore c,ArrayList<Camera> arr){
			...
			BarraMenuIS barra=new BarraMenuIS(frame,contenitore,14);
