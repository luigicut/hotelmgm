...
/**
 * Questa classe definisce un oggetto FrameRisultatiCameraOp
 * @author Daniele
 *
 */
public class FrameRisultatiRicercaCameraOp extends JFrame{
	 ...
	 */
		public FrameRisultatiRicercaCameraOp(Contenitore c,ArrayList<Camera> arr){
			...
			BarraMenuIS barra=new BarraMenuIS(frame,contenitore,23);
			...
			indice=0;
			int l=arrayCamera.size();
			
			String[] nomiColonne={"Numero","Piano","Numero Letti","Tipo","Stato"};
			//String[] nomiColonne={"Codice","Numero","DataInizio","DataFine"};
			String[][] celle=new String[l][5];
			
			 for(Camera cam:arrayCamera){
