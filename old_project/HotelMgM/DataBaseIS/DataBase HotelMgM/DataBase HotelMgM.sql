...
--
-- Host: localhost
-- Generato il: 20 mag, 2011 at 12:57 
...
-- Database: `account`
--
CREATE DATABASE `account` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `account`;
...
('admin89', 'salerno89', 'Daniele', 'Calabrò', '05/05/1989', 'Amministratore'),
...
('simy', 'bella', 'Simona', 'Marino', '19/11/1993', 'Operatore livello2');
--
-- Database: `hotelmgm`
--
CREATE DATABASE `hotelmgm` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `hotelmgm`;
...
(108, 1, 2, 'Doppia', 1),
(109, 1, 2, 'Doppia', 1),
(110, 1, 2, 'Matrimoniale', 0),
(200, 2, 2, 'Matrimoniale', 1),
(201, 2, 2, 'Matrimoniale', 1),
(202, 2, 2, 'Matrimoniale', 1),
(203, 2, 2, 'Matrimoniale', 1),
(204, 2, 3, 'Tripla', 0),
(205, 2, 3, 'Tripla', 1),
(206, 2, 3, 'Tripla', 1),
(207, 2, 3, 'Tripla', 1),
